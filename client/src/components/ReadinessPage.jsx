...
const CHECK_LABELS = ['Ingress', 'Load Balancer', 'Storage', 'Nodes']
    ...
    <div className="page active">
      ...
      {!environments.length ? (
        ...
        <div className="empty">
          ...
          <p>
            Checks ingress controller, load balancer, storage type, and node health across every connected environment.
          </p>
        </div>
      ) : (
